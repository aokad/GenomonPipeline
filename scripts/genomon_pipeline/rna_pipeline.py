...
for complist in sample_conf.fusion:
    ...
    tmp_chimeric_ctrl_sams = []
    # generate input list of 'fusion count'
    for panel_sample in sample_conf.control_panel[control_panel_name]:
        tmp_chimeric_ctrl_sams.append(run_conf.project_root + '/star/' + panel_sample + '/' + panel_sample + '.Chimeric.out.sam')
    chimeric_ctrl_sams = list(set(tmp_chimeric_ctrl_sams))
